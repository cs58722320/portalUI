    ...
    routes: [
        ...
        },
        {
            ...
            children:[
                {
                    path: '/memberPortal',
                    component: resolve => require(['../components/page/MemberPortal.vue'], resolve),
                    meta: { title: '会员查询' }
                },
                {
                    path: '/memberDetail',
                ...
                {
                    path: '/dataReport',
                    component: resolve => require(['../components/page/DataReport.vue'], resolve),
                    meta: { title: '数据报表' }
                },
                {
                    path: '/dashboard',
